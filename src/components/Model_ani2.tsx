...
export default function ModelAni2(props: JSX.IntrinsicElements['group']) {
  const group = useRef<THREE.Group>(null)
  const { nodes, materials, animations } = useGLTF('/model_ani2.glb') as unknown as GLTFResult
...
useGLTF.preload('/model_ani2.glb')
